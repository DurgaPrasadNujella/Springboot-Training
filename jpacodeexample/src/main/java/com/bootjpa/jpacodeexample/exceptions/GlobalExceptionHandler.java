...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(BootjpaNotFoundException.class)
	public final ResponseEntity<Object> handleBootjapNotException(
			BootjpaNotFoundException ex,WebRequest request){
		List<String> details= new ArrayList<>();
